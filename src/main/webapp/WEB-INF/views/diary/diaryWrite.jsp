...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Black+Han+Sans&family=Do+Hyeon&family=Dongle&family=Gamja+Flower&family=Nanum+Gothic:wght@400;800&family=Noto+Sans+KR:wght@300&family=Orbit&display=swap" rel="stylesheet">
    <title>일기 작성</title>
    <style>
...
<body>
    <div class="diary-container">
        ...
        <form id="diaryForm" action="/diarySave" method="post">
            <input class="title" type="text" id="diaryTitle" name="diaryTitle" placeholder="제목" spellcheck="false" required>
